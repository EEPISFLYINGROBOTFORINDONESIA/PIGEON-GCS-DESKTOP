...
namespace GUI_KRTI_BismillahNyoba
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GUI_KRTI_BismillahNyoba.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(GUI_KRTI_BismillahNyoba.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(GUI_KRTI_BismillahNyoba.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Maquette_Avion);
