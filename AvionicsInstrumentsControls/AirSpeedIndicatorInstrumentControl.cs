...
namespace GUI_KRTI_BismillahNyoba
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GUI_KRTI_BismillahNyoba.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(GUI_KRTI_BismillahNyoba.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.AirSpeedNeedle);
