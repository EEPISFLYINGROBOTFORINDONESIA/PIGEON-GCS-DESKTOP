...
namespace GUI_KRTI_BismillahNyoba
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GUI_KRTI_BismillahNyoba.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(GUI_KRTI_BismillahNyoba.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(GUI_KRTI_BismillahNyoba.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(GUI_KRTI_BismillahNyoba.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.TurnCoordinatorMarks);
