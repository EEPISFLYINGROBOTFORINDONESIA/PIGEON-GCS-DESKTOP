...
namespace GUI_KRTI_BismillahNyoba
{
    class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GUI_KRTI_BismillahNyoba.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(GUI_KRTI_BismillahNyoba.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.VerticalSpeedNeedle);
